...
For connecting to Direct Link, see [Configure {{site.data.keyword.cloud_notm}} Direct Link](../../docs/infrastructure/direct-link/subnet-configuration.html#configure-ibm-cloud-direct-link). If you need more help, you can request engineering support in the ticket that was opened for the new service. Even if it is an API service with Equinix, opening a ticket will enable an engineer to look at it. Or you can contact your IBM Sales representative.
