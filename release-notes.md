...
Check back regularly to see what's new with {{site.data.keyword.cloud}} Direct Link on Classic (1.0).
{: shortdesc}
...
IBM introduces a new Direct Link Dedicated release for VPC
:    Highlights include:
