...
## 对于 Direct Link 中的全球路由附加组件来说，如何收取出站（输出）带宽超额费用？
{:faq}
...
可以。如果您选择全球路由附加组件，那么您可以访问您所在区域外的区域。如果未选择此选项，那么您的 Direct Link 流量将限制在您所选的 PoP 位置的区域。请参阅[定价文档](/docs/infrastructure/direct-link/pricing.html)了解详细信息。
...
## 如果我使用 Direct Link 自动订购流程订购 Equinix Cloud Exchange，并为我分配了与我的内部网络重叠的子网，那怎么办？
{:faq}
...
目前，Direct Link 上没有 SLA。客户使用 BGP 正确配置 2 个或更多个 Direct Link 进行故障转移，可实现 99.999% 的有效性，但 IBM 无法控制这一点或在其上提供 SLA。
