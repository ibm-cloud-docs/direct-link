...
4. Pour le trafic de retour, {{site.data.keyword.cloud_notm}} utilise l'adresse IP CER affectée comme tronçon suivant pour tout trafic destiné au réseau distant, comme annoncé via BGP.
