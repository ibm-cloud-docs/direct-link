...
## ¿Cómo se facturan los excedentes de ancho de banda de salida (egress) para el complemento de direccionamiento global en Direct Link?
{:faq}
...
Sí, podrá tener acceso a áreas fuera de su región si elige el complemento de direccionamiento global. Si no se selecciona esta opción, el tráfico de Direct Link se limitará a la región para el PoP que haya seleccionado. Consulte el [documento sobre precios](/docs/infrastructure/direct-link/pricing.html) para obtener más información.
