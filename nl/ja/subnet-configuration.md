...
ご使用の環境とルート情報を交換するには、{{site.data.keyword.cloud_notm}} では BGP が構成されている必要があります。  
...
{{site.data.keyword.cloud_notm}} Direct Link は多様性を提供します。お客様は BGP スキーマによって冗長性を実装する必要があります。
