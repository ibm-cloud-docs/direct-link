...
## アカウントの BCR 接続に至るまで XCR 接続に関する SLA はありますか?

現在、DirectLink に関する SLA はありません。BGP を使用してフェイルオーバーについて適切に構成された Direct Link が 2 つ以上ある場合、お客様は実際上 99.999% を達成することが可能ですが、IBM が制御することはできず、それに関する SLA は提供しません。
