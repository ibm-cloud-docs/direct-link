 ...
 * **Opzioni di instradamento Locale/Globale:** l'opzione di instradamento locale fornisce l'accesso ai data center con lo stesso prefisso di tre lettere come l'ubicazione PoP (ad esempio DAL, AMS, MEL). L'opzione di instradamento globale è necessaria come un componente aggiuntivo per raggiungere i data center al di fuori di queste ubicazioni. 
 ...
 * **Opzioni di instradamento Locale/Globale:** l'opzione di instradamento locale fornisce l'accesso ai data center con lo stesso prefisso di tre lettere come il PoP (ad esempio DAL, AMS, MEL). L'opzione di instradamento globale è necessaria come un componente aggiuntivo per raggiungere i data center al di fuori di queste ubicazioni.
